...
const tyler: ChildPlaybook = {
  ...
  feedbackEntries: [
    {
      id: "fb-s1",
      caregiverName: "Anna Oliveira",
      caregiverRole: "Grandmother",
      dateLabel: "Jul 6",
      duration: "Under 5 min",
      helped: "yes" as const,
      note: "Tyler was calm the whole afternoon. We did puzzles and he asked to go outside twice.",
      context: "No" as const,
    ...
    },
    {
      ...
      caregiverRole: "EA · School",
      dateLabel: "Jul 5",
      duration: "5-15 min",
      helped: "not_fully" as const,
      note: "Loud hallway triggered some anxiety before lunch. Moved to quiet room and he settled after 10 minutes.",
      context: "Yes" as const,
    ...
    },
    {
      ...
      duration: "Under 5 min",
      helped: "yes" as const,
      note: "Great session. Tyler initiated a hug at the end of class.",
      context: "No" as const,
